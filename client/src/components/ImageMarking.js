...
const ImageMarking = () => {
    ...
    function getMousePosFromEvent(evt, canvas) {
      let rect = canvas.getBoundingClientRect();
      // console.log("MouseDown1: ", evt.clientX, rect.left, evt.clientX-rect.left);
      // console.log("MouseDown2: ", evt.clientY, rect.top, evt.clientY-rect.top);
      return {
    ...
    useEffect(() => {
      ...
      canvas.addEventListener('mousedown', function(event) {
        ...
        if (dragNode !== undefined) {
          ...
          console.log("dragPoint: ", dragPoint.x, dragPoint.y);
        }
      }, false);
      ...
      canvas.addEventListener('mousemove', function(event) {
        ...
        if (dragNode !== undefined) {
          ...
          pos = getMousePosFromEvent(event, canvas);
